<?php
/**
 * Script simple para probar dashboards
 */
...
<head>
    ...
    <title>Test Simple - SunObra</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-4">
        <h1><i class="fas fa-check-circle"></i> Test Simple de Dashboards</h1>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p><strong>Rol:</strong> <?= getUserRole() ?? 'No definido' ?></p>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5><i class="fas fa-link"></i> Enlaces Directos</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="diagnose-dashboards.php" class="btn btn-info">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <ol>
                    ...
                    <li><strong>Diagnóstico:</strong> Usa "Diagnóstico Completo" para obtener información detallada</li>
                    <li><strong>Limpiar:</strong> Usa "Limpiar Sesión" para probar sin autenticación</li>
                </ol>
                
                <div class="alert alert-info">
                    <strong>Nota:</strong> Este script no usa métodos protegidos y debería funcionar sin errores.
                </div>
            </div>
        </div>
    </div>
